...
<body class="bg-gray-100">
    ...
    <!-- checkout wrapper -->
     <div class="container grid grid-cols-12 items-start pb-16 pt-4 ml-40">
        <!-- checkout form -->
        <div class="col-span-8 border border-gray-200 p-4 rounded">
            <h3 class="text-lg font-medium capitalize mb-4">Checkout</h3>
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-2">
                    <label for="first-name" class="text-gray-600 mb-2 block">First Name<span class="text-red-500"> *</span></label>
                    <input type="text" id="first-name" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
                </div>
                <div class="space-y-2">
                    <label for="last-name" class="text-gray-600 mb-2 block">Last Name<span class="text-red-500"> *</span></label>
                    <input type="text" id="last-name" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
                </div>
            </div>
            <div class="space-y-2">
                <label for="Company-name" class="text-gray-600 mb-2 block">Company Name</label>
                <input type="text" id="Company-name" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
            <div class="space-y-2">
                <label for="country" class="text-gray-600 mb-2 block">Country/Region<span class="text-red-500"> *</span></label>
                <input type="text" id="country" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
            <div class="space-y-2">
                <label for="town" class="text-gray-600 mb-2 block">Town/City<span class="text-red-500"> *</span></label>
                <input type="text" id="town" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
            <div class="space-y-2">
                <label for="zip" class="text-gray-600 mb-2 block">Zip Code<span class="text-red-500"> *</span></label>
                <input type="text" id="zip" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
            <div class="space-y-2">
                <label for="Phone" class="text-gray-600 mb-2 block">Phone Number<span class="text-red-500"> *</span></label>
                <input type="text" id="Phone" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
            <div class="space-y-2">
                <label for="Email" class="text-gray-600 mb-2 block">Email Address<span class="text-red-500"> *</span></label>
                <input type="text" id="Email" class="block w-full border border-red-500 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-red-500 focus:ring-0">
            </div>
        </div>
        ...
        <!-- checkout form end -->
          ...
          <!-- keibar -->
          <div class="col-span-4 border border-gray-200 p-4 rounded ml-20">
            <h4 class="text-gray-800 text-lg mb-4 font-medium uppercase">Order Shap Sofa</h4>
            <div class="space-y-2 mb-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h5 class="text-gray-800 font-medium">Italian Shap</h5>
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center mb-4 mt-2">
                    <input type="checkbox" id="agreement" class="text-red-500 focus:ring-0 rounded-md cursor-pointer w-3 h-3">
                    <label for="agreement" class="text-gray-600 ml-3 cursor-pointer">Agree to our <a href="#" class="text-red-500">terms & condition</a></label>
                </div>
                <div class="mt-4">
                    <button type="submit" class="block w-full py-2 text-center text-white bg-red-500 border border-red-500 rounded hover:bg-transparent hover:text-red-500 transition uppercase font-roboto font-medium">Place order</button>
                </div>
            </div>
            </div>
          </div>
